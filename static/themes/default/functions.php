...
<div ng-controller="autoSuggestCtrl">
    ...
    <form autocomplete="off" action="<?php echo base_url(); ?>hotel/search" method="GET" role="search">
        <?php } else { ?>
  ...
  $(window).scroll(function () {
      ...
      if (moreResultsAvailable != '' && moreResultsAvailable == 1) {
        ...
        <div id="<?php if ($module == 'hotels') { echo 'dpd1'; } elseif ($module == 'ean') { echo 'dpean1'; } elseif ($module == 'tours') { echo 'tchkin'; } ?>" class="<?php echo $col2; ?> focusDateInput">
            <div class="row">
                <label class="hidden-xs go-right"><?php echo trans('07');?></label>
                <div class="clearfix"></div>
                <i class="iconspane-lg icon_set_1_icon-53"></i>
        ...
        <div id="dpd2" class="<?php echo $col2; ?> focusDateInput">
            <div class="row">
                <label class="hidden-xs go-right"><?php echo trans('09');?></label>
                <div class="clearfix"></div>
                <i class="iconspane-lg icon_set_1_icon-53"></i>
