      ...
      <div class="rooms-update" style="margin-top:0px;margin-bottom:0px">
        ...
        <div class="col-lg-9 col-md-8 offset-0">
          <div class="labelright go-left" style="min-width:180px;margin-left:5px">
            ...
            </b><span><?php echo trans('0245');?></span></span></h5>


            <div class="clearfix"></div>
            <div class="book">
              <span style="margin-bottom: 2px; padding: 4px; border-radius: 4px" <?php if(!empty($loggedin)){ ?> onclick="booknow()" <?php }else{ ?> data-toggle="modal" data-target="#book<?php echo $room['rateCode'];?>" <?php } ?> class="btn btn-action btn-block"><?php echo trans('0142');?></span>
            </div>
            <div class="clearfix"></div>
